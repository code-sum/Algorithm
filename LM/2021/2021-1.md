...
75. 다음 중 루프백(Loopback) IP 주소로 알맞은 것은?
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;④ 127.0.0.1  </div> </details>
...
79. 다음 중 CPU 반가상화를 지원하는 서버 가상화 기술로 알맞은 것은?
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;② XEN  </div> </details>
...
80. 다음 설명으로 알맞은 것은?
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;④ HPC(High Performance Computing) 클러스터  </div> </details>
