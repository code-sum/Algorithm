...
55. 다음 중 잘 알려진 포트(Well-Known Port)의 범위로 알맞은 것은?
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;① 0 ~ 1023  </div> </details>
...
68.  다음 중 UTP 케이블 카테고리(Category) 5e의 최대 전송속도로 가장 알맞은 것은?
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;④ 1 Gbps  </div> </details>
...
75.  다음 중 KDE와 가장 관련이 깊은 라이브러리로 알맞은 것은?
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;① Qt  </div> </details>
...
76. 다음 중 KDE에서 제공하는 이미지 뷰어 프로그램으로 알맞은 것은?
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;④ Gwenview  </div> </details>
...
77. 다음 중 X 서버에 IP 주소가 192.168.5.13 인 X 클라이언트의 접근을 허가하는 명령어로 알맞은 것은?
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;① xhost + 192.168.5.13  </div> </details>

78. 다음 설명에 해당하는 용어로 알맞은 것은?

    > GUI 환경을 이용하기 위해서 사용자에게 제공되는 인터페이스 스타일을 말한다. 파일관리자, 아이콘, 창, 도구, 모음, 폴더, 배경화면, 데스크톱 위젯을 제공하고 Drag & Drop 및 프로세스 간의 통보와 같은 기능도 제공한다.
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;① 데스크톱 환경  </div> </details>
...
79. 다음 중 윈도 매니저의 종류로 알맞은 것은?
    ...
    <details> <summary>정답</summary> <div markdown="1">&nbsp;&nbsp;&nbsp;③ Kwin  </div> </details>
